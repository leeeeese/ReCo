...
- **계층적 모델 선택**:
  - Orchestrator: gpt-5-mini (강력한 추론)
  - Sub-agents: gpt-4o-mini (빠른 처리)
- **타임아웃 설정**:
...
### 백엔드가 "Started reloader process"에서 멈춤
...
- DB에 데이터가 있는지 확인: `python server/db/migrate_csv.py`
- 검색어를 더 단순하게 입력 (예: "아이폰 14")
