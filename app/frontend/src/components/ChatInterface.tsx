          ...
          <div className="mt-8">
            ...
            <div className="flex justify-between items-center mb-4">
              <div className="flex-1">
                <label className="text-xs text-gray-600 mb-1 block">최소 가격</label>
                <Input
                  type="number"
                  value={minPrice}
              ...
              <div className="flex-1">
                <label className="text-xs text-gray-600 mb-1 block">최대 가격</label>
                <Input
                  type="number"
                  value={maxPrice}
            ...
            <div className="mt-4 flex flex-wrap gap-2">
              ...
              <button
                onClick={() => { setMinPrice(1000000); setMaxPrice(3000000); }}
                className="px-3 py-1 bg-gray-100 hover:bg-gray-200 rounded-xl text-sm transition-colors"
              >
                100만~300만
              </button>
