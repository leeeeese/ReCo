...
class ProductAgent:
    ...
    def analyze_product_characteristics(
        ...
        """
        LLM 기반으로 판매자가 판매하는 상품들을 3가지 핵심 분석으로 종합 평가:

        1) 판매자의 상품 품질 패턴 분석
           - 판매자가 올린 상품들의 상태(새상품·사용감·하자 여부 등)를 보고
           - "이 판매자는 어떤 수준의 상품을 주로 판매하는가?" 분석
           - 예: "퀄리티 높은 상품을 파는 사람", "저가형 위주 판매자"

        2) 시세 대비 가격 전략 분석
           - 판매자가 올린 모든 상품의 시세 대비 실제 판매가를 보고
           - "이 판매자는 평소에 싸게 파는가, 비싸게 파는가?" 가격 성향 파악
           - 예: "가성비 좋게 파는 판매자", "프리미엄 가격을 잡는 판매자"

        3) 판매자 성향 도출 (Seller Profiling)
           - 상품 상태 + 시세 대비 가격을 종합해서
           - "이 판매자가 어떤 성향의 사람인지" 프로파일링
           - 예: "좋은 물건을 싸게 파는 판매자", "상태 좋은 물건을 적정가에 파는 판매자"
        """
